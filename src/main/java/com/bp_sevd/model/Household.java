...
/*************ZISTENE SPOTREBY*************/
    ...
    @OneToOne
    @JoinColumn(name="user_id")             //ktoreho usera je to domacnost
    private User user;
    ...
    @ManyToOne
    @JoinColumn(name = "location_id")       //poloha domacnosti
    private Location location;


    @OneToOne(mappedBy = "household", cascade = CascadeType.ALL, orphanRemoval = true)      //spotrebice domacnosti
